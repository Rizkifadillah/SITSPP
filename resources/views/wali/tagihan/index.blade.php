...
@section('content')
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <h3 class="card-header">Data Tagihan SPP</h3>
                                ...
                                @forelse ($tagihan as $item)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @else
                                                <a href="" class="btn btn-info">Pembayaran Sudah Lunas</a>
                                            @endif    
