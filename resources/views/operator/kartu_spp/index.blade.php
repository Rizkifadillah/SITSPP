            ...
            <div class="row mt-4">
                <div class="col-12 col-lg-12">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div>
                                <span class="text-sm text-grey-m2 align-middle">Nama Siswa:</span>
                                <span class="text-600 text-110 text-blue align-middle">{{ $siswa->nama }}</span>
                            </div>
                        ...
                        <div class="text-95 col-sm-6 align-self-start d-sm-flex justify-content-end">
                            ...
                            <div class="text-grey-m2">
                                ...
                                <div class="my-2"><i class="fa fa-circle text-blue-m2 text-xs mr-1"></i> 
                                    <span class="text-600 text-90">ID:</span> #SMKY-{{ $siswa->id }}
                                </div>

                                <div class="my-2"><i class="fa fa-circle text-blue-m2 text-xs mr-1"></i> <span
                                        class="text-600 text-90">NISN:</span> {{ $siswa->nisn }}</div>

                                <div class="my-2"><i class="fa fa-circle text-blue-m2 text-xs mr-1"></i> <span
                                        class="text-600 text-90">Status:</span> <span
                                        {{-- class="badge badge-warning badge-pill px-25">{{ $pembayaran->tagihan->status }}</span> --}}
                                    </div>
                            </div>
                        </div>
                        <!-- /.col -->
                    ...
                    <div class="mt-4">
                        <div class="row text-600 text-white bgc-default-tp1 py-25">
                            ...
                            <div class="col-3 col-sm-3">Bulan Tagihan</div>
                            <div class="col-4 col-sm-4">Item Tagihan</div>
                            <div class="d-none d-sm-block col-2 col-sm-2">Total</div>
                            <div class="d-none d-sm-block col-sm-2">Paraf</div>
                        ...
                        <div class="text-95 text-secondary-d3">
                            @foreach ($tagihan as $item)
                                <div class="row mb-2 mb-sm-0 py-25">
                                    ...
                                    <div class="col-3 col-sm-3">{{ $item->tanggal_tagihan->translatedFormat('F Y') }}</div>
                                    <div class="col-4 col-sm-4">
                                        <ul>
                                            @foreach ($item->tagihanDetails as $itemDetails)
                                                <li>{{ $itemDetails->nama_biaya }} ({{ $itemDetails->jumlah_biaya }})</li>
                                            @endforeach
                                        </ul>
                                    </div>
                                    <div class="d-none d-sm-block col-2">{{ formatRupiahHelper($item->tagihanDetails->sum('jumlah_biaya')) }}</div>
